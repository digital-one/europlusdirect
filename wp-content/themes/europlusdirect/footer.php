...
<p><a href="" class="linkedin" title="Follow us on Linkedin"><?php _e('Follow us on','epd_theme'); ?> <span>Linkedin</span></a></p>
    <p><small>&copy;<?php echo date('Y') ?> <?php _e('Europlus Direct Limited. All rights reserved.','epd_theme'); ?> <a href="<?php echo get_permalink(816) ?>"><?php _e('Terms &amp; Conditions','epd_theme'); ?></a> | <a href="<?php echo get_permalink(818) ?>"><?php _e('Privacy Statement','epd_theme'); ?></a></small></p>
</div>
</div>
</footer>
<?php wp_footer() ?>

...
<h2 class="block-heading"><span><em>What the</em></span><span class="secondary"><em>industry says...</em></span></h2>
	</div>
</div>
</div>
...
<!--awards-->
<section id="awards" class="section row red-blue-heading blue-sub-heads red-btns pac skewed gutters overlap-bottom centered-text light-grey offset-up">
	<div class="section-inner">
		<div class="section-content">
<div class="row">
...
<div class="small-12 medium-6 medium-offset-3 columns">
	<div class="award">
		<figure class="large"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/queens-awards-2008-blue.jpg" /></figure>
	</div>

</div>

</div>
<h3 class="centered-text">Queen’s Award for International Trade 2008</h3>
<p>We won the Queen’s Award for International Trade in 2008 after our expertise in supplying IBM ServicePacs and services to a world-wide clientele had led us to increasing our exports by 610% in just three years. David Moore, speaking on behalf of the Prime Minister’s advisory committee, praised us as an extemporary example of a company making a success of the EU market, proclaiming us as an example for other British companies to follow.</p>
</div>
...
<!--awards-->
<section id="awards" class="section row red-blue-heading white-sub-heads above skewed centered-text blue offset-up spaced">
	<div class="section-inner">
		<div class="section-content">
<h3>Our other awards...</h3>
<div class="row">
	<div class="small-12 large-10 large-offset-1 columns">
		<div class="row">
			<div class="small-12 medium-4 medium-offset-2 columns"><div class="award"><figure><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/uk-trade-investment.jpg" /></figure><h4>Best Multilingual<br /> Website 2004</h4><p><a href="">Read more +</a></p></div></div>
<div class="small-12 medium-4 columns end"><div class="award"><figure><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/queens-awards-2013.jpg" /></figure><h4>Queen’s Award for<br />Enterprise 2013</h4><p><a href="">Read more +</a></p></div></div>
</div>
</div>
</div>

...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
	...
	<!--slide-->
		<div class="slide" style="background-image:url('<?php echo get_template_directory_uri(); ?>/images/lenovo-slide-bg.jpg');">
			...
			<div class="content"><div class="vcenter"><h2 class="block-heading"><span><em>We are</em></span><span><em>the specialists in Lenovo</em></span><span class="secondary"><em>maintenance services</em></span></h2></div></div>
		</div>
		</div>
		</div>
		<!--/slide-->
...
<li>Sed diam nonummy nib</li>
<li>Consectetuer adipiscing elit sed diam nonummy</li></ul>
